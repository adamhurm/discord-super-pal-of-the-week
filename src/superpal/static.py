...
###################
COMMANDS_MSG = (
    "**!spotw @name**\n\tPromote another user to super pal of the week. "
    "Be sure to @mention the user.\n"
    ...
    "**Bringus Card Game**\n"
    "**/card-draw**\n\tDraw a random Bringus card (up to 5 per week; Super Pal gets 10). "
    "Resets every Sunday.\n"
    "**/card-trade-in**\n\tTrade 3 duplicate cards of the same rarity "
    "for a new random card of that rarity.\n"
    "**/card-upgrade**\n\tSpend 5 duplicate cards to upgrade a member's card "
